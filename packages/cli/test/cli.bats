...
setup_file() {
  ...
  # Wait for auth server (returns 401 without key)
  for _ in $(seq 1 20); do
    local code
...
# Helper: assert JSON error envelope
assert_error() {
...
# Helper: HTTP status code shorthand
http_status() {
